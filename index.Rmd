...
```{r, out.width="600px", fig.cap="[Baker, 2016](http://doi.org/10.1038/533452a)"}
...
## Do we have the power we need? {.smaller}
...
```{r, out.width="750px", fig.cap="[Marek et al. 2022](http://dx.doi.org/10.1038/s41586-022-04492-9)"}
